<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Ikhwanda Pratama</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://i.pinimg.com/736x/d7/9c/00/d79c0021367fc055f222ef84b4a3e5a6.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Newbie Web Developer", "Newbie Backend", "Informatics Student", "Bengkulu"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
...
.pict {
  box-shadow: 0px 0px 73px -9px rgba(17, 20, 156, 0.44);
-webkit-box-shadow: 0px 0px 73px -9px rgb(253, 253, 253);
-moz-box-shadow: 0px 0px 73px -9px rgb(255, 255, 255);
}
